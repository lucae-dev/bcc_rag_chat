...
@Configuration
@MapperScan(basePackages = "bck_rag_chat.mapper.primary", sqlSessionFactoryRef = "primarySqlSessionFactory")
public class DataSourceConfig {
    ...
    public SqlSessionFactory primarySqlSessionFactory(@Qualifier("primaryDataSource") DataSource dataSource) throws Exception {
        ...
        // Set type aliases
        //factoryBean.setTypeAliasesPackage("bck_rag_chat.model");
        // Set Type Handlers
        factoryBean.setTypeHandlersPackage("bck_rag_chat.configuration.typehandler");
